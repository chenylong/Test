var dataString ='<chart palette="2" caption="Investment Analysis Tool" subcaption="Drag over the required investments to select them. You can have multiple selections." yAxisName="Returns till date" xAxisName="Age (years)" showLegend="1" showNames="1" xAxisMaxValue="10" xAxisMinValue="0" showFormBtn="0" numberSuffix="%" anchorRadius="5">\n\
    ...
    <dataSet id="EQS" seriesName="Equities" color="0372AB" plotBorderThickness="0" showPlotBorder="1" anchorSides="3" anchorBgColor="0372AB"  anchorBgAlpha="50">\n\
    ...
    <dataSet id="MFS" seriesName="Mutual Funds" color="FF9900" showPlotBorder="1" anchorRadius="5" anchorBgColor="FF9900" anchorBgAlpha="50">\n\
