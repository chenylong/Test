var dataString ='<chart palette="1" caption="Please estimate product sales for 2007, 2008 & 2009" subcaption="Drag the anchors (markers) to adjust data" showvalues="0" xAxisName="Year" yAxisName="Units" restoreBtnBorderColor="A2A3A0" formBtnBorderColor="A2A3A0" canvasPadding="20" dragBorderThickness="3" formAction="DataHandler.html">\n\
<categories>\n\
...
<dataset id="LJ" seriesName="Laser Printers" showValues="0" dragBorderColor="0099FF">\n\
...
<dataset id="CR" seriesName="Cartridges" showValues="0" dragBorderColor="CC9900">\n\
...
<dataset id="IJ" seriesName="Inkjet Printers" dragBorderColor="D1E78F">\n\
