var dataString='<chart palette="3" caption="Investment Analysis Tool" subcaption="Drag over the required investments to select them. You can have multiple selections." yAxisName="Returns till date" xAxisName="Age (years)" showLegend="1" showNames="1" xAxisMaxValue="10" xAxisMinValue="0" submitDataAsXML="0" showFormBtn="1" formAction="DataHandler.html" numberSuffix="%" formBtnBorderColor="0372AB" formBtnBorderAlpha="60" formBtnTitle="Perform Analysis" formBtnWidth="120">\n\
...
<dataSet id="DS1" seriesName="Equities" color="0372AB" plotBorderThickness="0" showPlotBorder="1" anchorSides="3">\n\
