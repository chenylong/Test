var dataString ='<chart caption="Number of yellow cards per match in World Cup - 2010 v 2006" subcaption="(The chart uses random data for demonstration purposes only)" showValues="0" numDivLines="3">\n\
<categories>\n\
