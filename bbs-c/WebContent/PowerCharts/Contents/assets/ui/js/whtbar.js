...
function addSearchForm()
{
	...
	if("image"=="text")
	{
		sButton+="<td NOWRAP valign=\"middle\"><a class=\"searchbtn\" href=../../../Overview.html onclick=\"searchForm.submit(); return false;\"></a></td>";
	}
	else if("image"=="image"&&gsIGo)
	{
		sButton+="<td NOWRAP valign=\"middle\"><a class=\"searchbtn\" href=../../../Overview.html onclick=\"searchForm.submit(); return false;\">"
...
function addBanner(sImage)
{
	...
	{
		var nBtn=gaButtons.length;
		gaButtons[nBtn]="<td NOWRAP align=\"center\" valign=\"middle\">     <a href=../../../Overview.html onclick=\"showBanner();return false;\"><img alt=\"About WebHelp\"src=\""+sImage+"\" border=0 align=\"absmiddle\"></a></td>";
		gaTypes[nBtn]="banner";
	}
}
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	if(sType=="show"&&isShowHideEnable())
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnshowhide\" class=\"btnshow\" href=../../../Overview.html onclick=\"showHidePane();return false;\">";
	...
	else if(sType=="hide"&&isShowHideEnable())
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnshowhide\" class=\"btnhide\" href=../../../Overview.html onclick=\"showHidePane();return false;\">";
		gnShowHideStyle=nStyle;
	...
	{
		var svTitle="Hide Navigation Component";
		sButton="<a title=\""+svTitle+"\" id=\"btnhide\" class=\"btnhide\" href=../../../Overview.html onclick=\"showHidePane();return false;\">";
		gnShowHideStyle=nStyle;
		if(!sI1)
			sI1=gsIHide;
	...
	else if(sType=="synctoc")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnsynctoc\" class=\"btnsynctoc\" href=../../../Overview.html onclick=\"syncWithShow();return false;\">";
		if(!sI1)
			sI1=gsISync;
	...
	else if(sType=="toc")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btntoc\" class=\"btntoc\" href=../../../Overview.html onclick=\"showToc();return false;\">";
		if(!sI1)
			sI1=gsIToc;
		if(!sI2)
			sI2=gsITocS;
	...
	{
		var svTitle="Index";
		sButton="<a title=\""+svTitle+"\" id=\"btnidx\" class=\"btnidx\" href=../../../Overview.html onclick=\"showIndex();return false;\">";
		if(!sI1)
			sI1=gsIIndex;
		if(!sI2)
			sI2=gsIIndexS;
	...
	{
		var svTitle="Search";
		sButton="<a title=\""+svTitle+"\" id=\"btnfts\" class=\"btnfts\" href=../../../Overview.html onclick=\"showFts();return false;\">";
		if(!sI1)
			sI1=gsISearch;
		if(!sI2)
			sI2=gsISearchS;
	...
	else if(sType=="glo")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnglo\" class=\"btnglo\" href=../../../Overview.html onclick=\"showGlossary();return false;\">";
		if(!sI1)
			sI1=gsIGlossary;
		if(!sI2)
			sI2=gsIGlossaryS;
	...
	else if(sType=="avnext")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnavnext\" class=\"btnavnext\" href=../../../Overview.html onclick=\"goAveNext();return false;\">";
		if(!sI1)
			sI1=gsINext;
		if(!sI4)
			sI4=gsINextD;
	...
	else if(sType=="avprev")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnavprev\" class=\"btnavprev\" href=../../../Overview.html onclick=\"goAvePrev();return false;\">";
		if(!sI1)
			sI1=gsIPrev;
		if(!sI4)
			sI4=gsIPrevD;
	...
	else if(sType=="websearch")
	{
		...
		sButton="<a title=\""+svTitle+"\" id=\"btnwebsearch\" class=\"btnwebsearch\" href=../../../Overview.html onclick=\"doWebSearch();return false;\">";
		if(!sI1)
			sI1=gsIWebSearch;
		if(!sI4)
			sI4=gsIWebSearchD;
	...
	else if(sType.indexOf("custom")==0)
	{
		...
		{
			sButton="<a title=\""+svTitle+"\" id=\"btn"+sType+"\" class=\"btn"+sType+"\" target=\"contentFrame\" href=\""+sHref+"\" onclick=\"cusOnClick("+nCusBtnIdx+");";
			bHref=true;
		}
		else
