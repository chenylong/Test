...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	if(sType=="prev")
	{
		if(canGo(false))
		{
			...
			sButton="<a title=\""+sTitle+"\" class=\"whtbtnprev\" href=../../../Overview.html onclick=\"goAvenue(false);return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="next")
	{
		if(canGo(true))
		{
			...
			sButton="<a title=\""+sTitle+"\" class=\"whtbtnnext\" href=../../../Overview.html onclick=\"goAvenue(true);return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="show")
	{
		if(isTopicOnly()&&(!gbOpera6||gbOpera7))
		{
			...
			sButton="<a title=\""+sTitle+"\" class=\"whtbtnshow\" href=../../../Overview.html onclick=\"show();return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="hide")
	{
		if(!isTopicOnly()&&!gbOpera6)
		{
			...
			sButton="<a title=\""+sTitle+"\" class=\"whtbtnhide\" href=../../../Overview.html onclick=\"hide();return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="shownav" )
	{
		if(isShowHideEnable()|| true)
		{
			...
			sButton="<a id=\"showNavButtonId\" title=\""+sTitle+"\" class=\"whtbtnshownav\" href=../../../Overview.html onclick=\"showHidePane(true); toggleShowHideButton(this,'hideNavButtonId');return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="hidenav")
	{
		if(isShowHideEnable() || true)
		{
			...
			sButton="<a id=\"hideNavButtonId\" title=\""+sTitle+"\" class=\"whtbtnhidenav\" href=../../../Overview.html onclick=\"showHidePane(false);  toggleShowHideButton(this,'showNavButtonId');;return false;\">";
			if(nStyle==BTN_TEXT)
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			...
			sButton="<a title=\""+sTitle+"\" class=\"whtbtnsynctoc\" href=../../../Overview.html onclick=\"syncWithShow();return false;\">";
			if(nStyle==BTN_TEXT)
...
function getSearchFormHTML()
{
	...
	if(""=="text")
	{
		sButton+="<a class=\"searchbtn\" href=../../../Overview.html onclick=\""+sFormName+".submit();return false;\"></a>";
	}
	else if(""=="image")
	{
		sButton+="<a class=\"searchbtn\" href=../../../Overview.html onclick=\""+sFormName+".submit();return false;\">"
...
if(window.gbWhUtil && window.gbWhVer && (gbAIRSSL ||(window.gbWhMsg&&window.gbWhProxy)))
{
	if(!gbAIRSSL)
	{
		RegisterListener("contentFrame",WH_MSG_GETAVIAVENUES);
		RegisterListener("contentFrame",WH_MSG_GETTOCPATHS);
		RegisterListener("contentFrame",WH_MSG_NEXT);
		RegisterListener("contentFrame",WH_MSG_PREV);
		RegisterListener("contentFrame",WH_MSG_WEBSEARCH);
	}
	if(gbMac&&gbIE4)
	{
